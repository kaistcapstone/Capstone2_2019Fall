"""
    ...
    The modified version for usage in Prioritized DQN is copied/adapted from
...
class ReplayBuffer(object):
    def __init__(self, size, frame_history_len, prob_alpha=0.6):
...
########################################################################################################
        ...
        self.buffer = []
        #self.pos        = 0   -> the same as self.next_idx
...
##########################################################################################
        ...
        #     nrca = 1
        #     probs = self.prob_alpha
        # else:
        #     nrca = len(self.buffer)
        idxes = np.random.choice(len(self.buffer), batch_size, p=probs)
...
##########################################################################################
        ...
        return obs_batch, act_batch, rew_batch, next_obs_batch, done_mask, idxes, weights
