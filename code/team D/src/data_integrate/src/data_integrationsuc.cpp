...
float k3=26; float c1 = 15;
float c2 = 15; float c3 = 730; //int ball_number; //float ball_X[20]; //float ball_Y[20];
							...
							else
							{
								...
								if (sssw==0){
									if (catordog==1){
										...
										secondrelease =0;
										ssww=0;
										cout<<"im catdog=1"<<endl;
									}
									else if(catordog==2){
										data[16]=0;
										secondrelease =0;
										ssww=1;
										cout<<"im catdog=2"<<endl;
									}
									sssw=1;
								}
								else if (sssw==1){
									if (ssww==0){
										data[16]=0;
										cout<<"im 2catdog=1"<<endl;
									}
									else{
										data[16]=1;
										cout<<"im 2catdog=2"<<endl;
									}
								}
